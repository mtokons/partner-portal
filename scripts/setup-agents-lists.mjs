...
async function run() {
  ...
  await createListIfNotExists(siteId, "AgentRuns", [
    { name: "Persona", text: {} },
    { name: "PromptVersion", text: {} },
    { name: "Provider", text: {} },
    { name: "Model", text: {} },
    { name: "InputHash", text: {} },
    { name: "TokensIn", number: {} },
    { name: "TokensOut", number: {} },
    { name: "CostUsd", number: {} },
    { name: "LatencyMs", number: {} },
    { name: "Status", text: {} },
    { name: "ContextRef", text: {} },
    { name: "CreatedAt", text: {} },
  ]);

  await createListIfNotExists(siteId, "EvaluationScoreDetails", [
    { name: "EvaluationId", text: {} },
    { name: "IntakeId", text: {} },
    { name: "ProjectId", text: {} },
    { name: "CriterionLabel", text: multiline },
    { name: "Category", text: {} },
    { name: "AiScore", number: {} },
    { name: "Score", number: {} },
    { name: "MaxPoints", number: {} },
    { name: "Evidence", text: multiline },
    { name: "EvidenceVerified", text: {} },
    { name: "Confidence", number: {} },
    { name: "Reasoning", text: multiline },
    { name: "Threshold", text: {} },
    { name: "NeedsReview", text: {} },
    { name: "Reviewed", text: {} },
    { name: "ReviewedBy", text: {} },
    { name: "Provider", text: {} },
    { name: "RunId", text: {} },
    { name: "CreatedAt", text: {} },
    { name: "UpdatedAt", text: {} },
  ...
  await createListIfNotExists(siteId, "TorDocuments", [
    { name: "ProjectId", text: {} },
    { name: "FileName", text: {} },
    { name: "RawText", text: multiline },
    { name: "StructureJson", text: multiline },
    { name: "Status", text: {} },
    { name: "Provider", text: {} },
    { name: "RunId", text: {} },
    { name: "CreatedAt", text: {} },
  ...
  await createListIfNotExists(siteId, "Deliverables", [
    { name: "ProjectId", text: {} },
    { name: "DraftText", text: multiline },
    { name: "EditorNotesJson", text: multiline },
    { name: "SourceRefsJson", text: multiline },
    { name: "Status", text: {} },
    { name: "Provider", text: {} },
    { name: "RunId", text: {} },
    { name: "CreatedAt", text: {} },
  ...
  console.log("\n✅ Agent (AI) SharePoint lists are ready.");
}
