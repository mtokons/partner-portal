...
export const mockProducts: Product[] = [
  ...
  { id: "gc1", sku: "SCCG-GC-3500", name: "SCCG Gift Card - BDT 3,500", description: "Redeemable for 3,500 SCCG Coins. Can be used for all services.", unit: "Card", sessionsCount: 0, retailPriceEur: 25, retailPriceBdt: 3500, price: 3500, stock: 999, category: "Gift Card", imageUrl: "" },
  { id: "gc2", sku: "SCCG-GC-5000", name: "SCCG Gift Card - BDT 5,000", description: "Redeemable for 5,000 SCCG Coins. Can be used for all services.", unit: "Card", sessionsCount: 0, retailPriceEur: 35, retailPriceBdt: 5000, price: 5000, stock: 999, category: "Gift Card", imageUrl: "" },
  { id: "gc3", sku: "SCCG-GC-10000", name: "SCCG Gift Card - BDT 10,000", description: "Redeemable for 10,000 SCCG Coins. Can be used for all services.", unit: "Card", sessionsCount: 0, retailPriceEur: 70, retailPriceBdt: 10000, price: 10000, stock: 999, category: "Gift Card", imageUrl: "" },
