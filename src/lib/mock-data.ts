...
export const mockProducts: Product[] = [
  ...
  { id: "gc1", sku: "SCCG-GC-3500", name: "SCCG Gift Card - ৳3,500", description: "Standard Gift Card. Redeemable for 3,500 SCCG Coins.", unit: "Card", sessionsCount: 0, retailPriceEur: 28, retailPriceBdt: 3500, price: 3500, stock: 999, category: "Gift Card", imageUrl: "" },
  { id: "gc2", sku: "SCCG-GC-5000", name: "SCCG Gift Card - ৳5,000", description: "Value Gift Card. Redeemable for 5,000 SCCG Coins.", unit: "Card", sessionsCount: 0, retailPriceEur: 41, retailPriceBdt: 5000, price: 5000, stock: 999, category: "Gift Card", imageUrl: "" },
  { id: "gc3", sku: "SCCG-GC-10000", name: "SCCG Gift Card - ৳10,000", description: "Premium Gift Card. Redeemable for 10,000 SCCG Coins.", unit: "Card", sessionsCount: 0, retailPriceEur: 82, retailPriceBdt: 10000, price: 10000, stock: 999, category: "Gift Card", imageUrl: "" },
