...
import { createSalesOfferAction, loadCreateOfferData } from "../../actions";
  ...
  return (
    <div className="space-y-6 page-enter">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-black text-foreground">Create Sales Offer</h1>
          <p className="text-sm text-muted-foreground">Fill in the details below to create a new offer.</p>
        </div>
      </div>
          ...
          <Card className="sticky top-24">
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                disabled={saving || !clientId || items.length === 0 || items.some((i) => !i.productId)}
              >
