...
export default async function TeachersPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {error ? (
        <Card className="col-span-full border-0 shadow-2xl rounded-[32px] bg-red-50 p-10 text-center">
          <p className="text-red-600 font-bold">{error}</p>
          <p className="text-sm text-red-400 mt-2">Please ensure you have the necessary permissions and try refreshing the page.</p>
        </Card>
      ) : (
